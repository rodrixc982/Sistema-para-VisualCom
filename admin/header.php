  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      <a href="index.php" class="logo">
        ...
        <span class="logo-lg"><b>VISUALCOM</b></span>
      </a>
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="treeview">
            <a href="#">
              ...
              <span>DEUDAS Y CUENTAS POR COBRAR</span>
              <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
            </a>
            <ul class="treeview-menu" style="display: none;">
              <li><a href="hutang.php"><i class="fa fa-circle-o"></i> Notas de cuentas por pagar</a></li>
              <li><a href="piutang.php"><i class="fa fa-circle-o"></i> Notas de cuentas por cobrar</a></li>
            </ul>
          </li>
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu" style="display: none;">
              <li><a href="transaksi_bsi.php"><i class="fa fa-circle-o"></i> CUENTA MANUEL REYNA</a></li>
              <li><a href="transaksi_bca.php"><i class="fa fa-circle-o"></i> CUENTA TIANZ</a></li>
              <li><a href="transaksi_cash.php"><i class="fa fa-circle-o"></i> EFECTIVO</a></li>
            </ul>
          </li>

          <li>
            <a href="bank.php">
              <i class="fa fa-building"></i> <span>CUENTAS</span>
            </a>
          </li>
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu" style="display: none;">
              <li><a href="user.php"><i class="fa fa-circle-o"></i> Datos del usuario</a></li>
              <li><a href="user_tambah.php"><i class="fa fa-circle-o"></i> Agregar usuario</a></li>
            </ul>
          </li>

          <li>
            <a href="laporan.php">
              <i class="fa fa-file"></i> <span>INFORME</span>
            </a>
          </li>

          <li>
            <a href="gantipassword.php">
              <i class="fa fa-lock"></i> <span>CAMBIAR LA CONTRASEÑA</span>
            </a>
          </li>
