...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      FLUJO
      <small> De Datos de Ingresos y Gastos</small>
    </h1>
    <ol class="breadcrumb">
      ...
      <section class="col-lg-12">
        <div class="box box-info">
          ...
          <div class="box-header">
            <h3 class="box-title">Flujo de ingresos y gastos</h3>
              ...
              <table class="table table-bordered table-striped" id="table-datatable">
                <thead>
                  <tr>
                    ...
                    <th rowspan="2" class="text-center">INFORMACION</th>
                    <th colspan="2" class="text-center">TIPO</th>
                    <th rowspan="2" width="10%" class="text-center">OPCION</th>
                  </tr>
                  <tr>
                                ...
                                <div class="modal-body">
                                  ...
                                  <div class="form-group" style="width:100%;margin-bottom:20px">
                                    ...
                                    <select name="jenis" style="width:100%" class="form-control" required="required">
                                      <option value="">- Elegir -</option>
                                      <option <?php if($d['transaksi_jenis'] == "Pemasukan"){echo "selected='selected'";} ?> value="Pemasukan">INGRESO</option>
                                      <option <?php if($d['transaksi_jenis'] == "Pengeluaran"){echo "selected='selected'";} ?> value="Pengeluaran">GASTO</option>
                                    </select>
                                  </div>
                                  ...
                                  <div class="form-group" style="width:100%;margin-bottom:20px">
                                    <label>Valor</label>
                                    <input type="number" style="width:100%" name="nominal" required="required" class="form-control" placeholder="Ingrese la cantidad .." value="<?php echo $d['transaksi_nominal'] ?>">
                                  </div>
