      ...
      <section class="col-lg-12">
        <div class="box box-info">
          ...
          <div class="box-header">
            <h3 class="box-title">Transacciones de ingresos y gastos</h3>
            <div class="btn-group pull-right">            

              <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#exampleModal">
                <i class="fa fa-plus"></i> &nbsp Agregar transacción
              </button>
            </div>
          </div>
          <div class="box-body">
                ...
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrado</button>
              ...
              <table class="table table-bordered table-striped" id="table-datatable">
                <thead>
                  <tr>
                    ...
                    <th rowspan="2" width="10%" class="text-center">OPCIÓN</th>
                  </tr>
                  <tr>
