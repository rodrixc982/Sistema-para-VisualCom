  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2024</strong> - CRISTFW
  </footer>
...
<script>
  ...
  var barChartData = {
    labels : ["Enero","Febrero","Marzo","Abrir","Mayo","Junio","Julio","Agosto","Setiembre","Octumbre","Noviembre","Diciembre"],
    datasets : [
    {
      label: 'Ingreso',
  ...
  window.onload = function(){
    ...
    window.myBar = new Chart(ctx).Bar(barChartData, {
     ...
     multiTooltipTemplate: "<%= datasetLabel %> - S/.<%= value.toLocaleString() %>"
   });
