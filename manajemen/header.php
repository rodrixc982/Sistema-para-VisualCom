  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      <a href="index.php" class="logo">
        ...
        <span class="logo-lg"><b>Flujo de Caja</b></span>
      </a>
    ...
    <aside class="main-sidebar">
      <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li>
            <a href="kategori.php">
              <i class="fa fa-folder"></i> <span>DATOS DE CATEGORÍA</span>
            </a>
          </li>

          <li>
            <a href="transaksi.php">
              <i class="fa fa-folder"></i> <span>DATOS DE LA TRANSACCIÓN</span>
            </a>
          </li>
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu" style="display: none;">
              <li><a href="transaksi_bsi.php"><i class="fa fa-circle-o"></i> BANCO BSI</a></li>
              <li><a href="transaksi_bca.php"><i class="fa fa-circle-o"></i> BANCO BCA</a></li>
              <li><a href="transaksi_cash.php"><i class="fa fa-circle-o"></i> DINERO</a></li>
            </ul>
          </li>
          <li>
            <a href="bank.php">
              <i class="fa fa-building"></i> <span>CUENTA BANCARIA</span>
            </a>
          </li>
